    ...
    return (
        <main className="w-screen h-screen relative overflow-hidden">
            ...
            <div className="relative z-10 flex items-center justify-center h-screen">
                <div className="bg-white py-8 px-25 rounded-2xl flex flex-col shadow-lg shadow-black">
                    ...
                    <h1 className="text-black text-xl font-bold mb-2 ml-2">Sign Up</h1>
                    <input
                        type="text"
                    ...
                    <div className='flex justify-center'>
                        <button className='cursor-pointer bg-[#74CFDE] rounded-3xl w-60 py-2 mt-4 px-5 hover:bg-[#5fb6c8] hover:shadow-lg transition duration-300 ease-in-out'>Sign Up</button>
                    </div>
                    <div className='flex justify-center'>
                        <button
                    ...
                    <div className='flex flex-row items-center justify-center mt-6'>
                        <span className='text-black text-sm font-bold'>Already have an account?</span>
                        <span className='text-[#9DCD5A] text-sm font-semibold ml-1 hover:underline hover:text-[#7FBF3E] cursor-pointer'
                        onClick={handleRedirecttoLogin}>Log In!</span>
                    </div>
                </div>
            </div>
        </main>
